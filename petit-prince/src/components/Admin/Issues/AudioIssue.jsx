...
const AudioIssue = ({audiodata, ad_name, language, sentence, sentence_id, trans_desc_id, subtype, type}) => {
  ...
  const onSubmitForm = (e) => {
    ...
    console.log(messageIntro + message + discardedMessage + recordAgainMessage);
  }
